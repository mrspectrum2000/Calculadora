...
/**
 * Esta es una versión editada del programa original del maestro Oropeza, a la cual se implementaron
 * funciones trigonometricas y de raíz, así como logaritmicas.
 * Interfaz para nuestra calculadora basica
 * 
 * @author:  Elliot Nez Arredondo
 * @version:  1.0 
 * @date: 06-09-2015 
 * Edited by : Elliot Nez Arredondo
 */
		...
		if (operacion.equals("+")) {
			...
			resultado *= new Double(pantalla.getText());
                       ...
                       resultado = new Double(Math.sqrt(Double.parseDouble(pantalla.getText())));
                         ...
                         resultado = new Double(Math.sin(Double.parseDouble(pantalla.getText())));
                } else if (operacion.equals("Cos")){
                         resultado = new Double(Math.cos(Double.parseDouble(pantalla.getText())));
                } else if (operacion.equals("Tan")){
                         resultado = new Double(Math.tan(Double.parseDouble(pantalla.getText())));
                } else if (operacion.equals("Log")){
                         resultado = new Double(Math.log(Double.parseDouble(pantalla.getText())));
                }
